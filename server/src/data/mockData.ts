...
// ---------------------------------------------------------------------------
// Mock Data — copied exactly from Zyra assessment specification
// IDs and structure are unchanged.
// ---------------------------------------------------------------------------
...
export const tasks: Task[] = [
  ...
  },
  {
    ...
    description:
      "All 6 schools require official transcripts via Naviance.",
    status: "completed",
    priority: "urgent",
    dueDate: "2026-05-13",
  ...
  },
  {
    ...
    description:
      "Must complete online modules to recover failing grade.",
    status: "todo",
    priority: "urgent",
    dueDate: "2026-05-30",
...
export const messages: Message[] = [
  {
    ...
    preview:
      "Maya has not submitted the last three homework sets...",
    read: false,
  ...
  },
  {
    ...
    preview:
      "Maya was marked absent on May 25. Please follow up...",
    read: true,
